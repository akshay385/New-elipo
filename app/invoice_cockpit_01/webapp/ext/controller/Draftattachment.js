    ...
    function (MessageBox, MessageToast, UIComponent) {
        ...
        function _createUploadController(oExtensionAPI, Entity) {
            ...
            return {
                ...
                onOk: function (oEvent) {
                 debugger;
                    let inputString = oEvent.oSource.oPropagatedProperties.oModels.pageInternal.mContexts["/pages/invoicecockpit01::NewObjectPage/controls/fe::FormContainer::GeneratedFacet1"].oModel.oData.currentCtxt.sPath;
